...
async function salvarTokenFCMNoServidor(token) {
    ...
    try {
        ...
        return new Promise((resolve) => {
            ...
            const url = `https://script.google.com/macros/s/AKfycbzsRBTwWp49OzGpKVbTikEf0DfYmTV2xqaenXhUEVQBefeOC2IMh_HH5TBZs0nMqbICDw/exec?callback=${callbackName}&acao=salvarSubscription&fcmToken=${encodeURIComponent(token)}&tipo=firebase&email=${encodeURIComponent(userEmail)}`;
